...
\subsection{Integral of nonnegative simple functions}
\begin{definition}
...
\begin{remark}
    ...
    \end{itemize}
\end{remark}
\subsection{Integral of nonnegative measurable functions}
\begin{definition}
...
\end{proof}
\subsection{Integration of series of nonnegative functions}
...
\subsection{Integrable functionss}
\(X, \mathcal{M}, \mu\) complete measure space. \\
